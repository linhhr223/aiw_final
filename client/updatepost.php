...
<div class="body-content outer-top-xs" id="content">
    <div class="container" id="contai">
        <div class="row">
            ...
            <?php
            if(isset($_GET['id'])):
                $newdetail = file_get_contents("http://restapi.test/server/index.php?post=".$_GET['id']);
